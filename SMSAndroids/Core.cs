...
//                    PrintConditionsAndTriggers(gameplay.Find("TransferScene").gameObject);
                }
            }
            ...
            //{
            //    var mapButtons = mainCanvas?.Find("Navigator")?.Find("MapButtons")?.gameObject;
            //    if (mapButtons != null)
            //    {
                                    ...
                                    if (branch != null)
                                    {
                                        ...
                                        if (conditionField != null)
                                        {
                                            ...
                                            if (condition != null)
                                            {
                                                ...
                                                // Else, just print its basic fields for debugging
                                                else
                                                {
